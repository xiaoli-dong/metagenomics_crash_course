...
use warnings;
$#ARGV == -1
    and die "by Xiaoli Dong <xdong\@ucalgary.ca> from EBG group at University of Calgary\n".
     "Usage: $0 <img_metadata.tsv: located under path_to_your_checkM_program/data/img/> <concatenated tree generated from checkM>\n";
