...
* [Reconstruct the full-length SSU rRNA](https://github.com/xiaoli-dong/metagenomics_crash_course/blob/master/phyloflash/README.md#rapidly-reconstruct-the-ssu-rrnas) using phyloFlash
